...
const Mockups = (function() {
  ...
  function generateMockupThumbnails(mockups) {
    ...
    if (mockups.length === 0) {
      ...
      if (mockups.length > 0) {
        changeMockup(mockups[0].path, mockups[0].name, mockups[0].id, mockups[0].model || "Inne");
      }
    }
  ...
  function changeMockup(mockupPath, mockupName, mockupId, mockupModel) {
    ...
    const instructionsWereVisible = Elements.dragInstruction.style.display === "block";
